...
class CardControllerTest {
    ...
    void generateNumber_InvalidProductId_ShouldReturnErrorResponse() throws Exception {
        ...
        when(service.add(any(CardVO.class))).thenThrow(new RuleException("Invalid product"));
    ...
    void enroll_InvalidCardVOid_ShouldReturnErrorResponse() throws Exception {
        ...
        when(service.enroll(any(CardVOid.class))).thenThrow(new RuntimeException("Invalid card"));
    ...
    void rechargeBalance_InvalidBalanceCard_ShouldReturnErrorResponse() throws Exception {
        ...
        when(service.balance(any(BalanceCard.class))).thenThrow(new RuntimeException("Invalid balance card"));
