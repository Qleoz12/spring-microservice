...
public class ProfileVO extends DTO<Profile> {
    ...
    private List<PermissionDTO> permissoes;
    ...
    public Profile toEntidade() {
        return Profile.builder()
                ...
                .permissoes(CollectionUtils.isEmpty(this.permissoes) ? null : this.permissoes.stream().map(PermissionDTO::toEntidade).collect(Collectors.toSet()))
                .build();
    }
